            ...
            <div className="grid md:grid-cols-2 pb-32 gap-10 px-10 pt-20">
                <div>
                    <div className="relative">
                        <p className="text-white font-[500] bg-gradient-to-b from-[#3E205A] to-[#E84756] h-full p-5 pt-8 border-solid border-white border-[6px] rounded-3xl overflow-hidden shadow-2xl">"PTD KSEP ITB 2024 sebagai penumbuh pembelajar ekonomi dan pasar modal
                ...
                <div>
                    <div className="relative">
                        <p className="text-white font-[500] bg-gradient-to-b from-[#3E205A] to-[#E84756] h-full p-5 pt-8 border-solid border-white border-[6px] rounded-3xl overflow-hidden shadow-2xl">
